...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { creation_date: @deck.creation_date, description: @deck.description, last_modified: @deck.last_modified, title: @deck.title }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { creation_date: @deck.creation_date, description: @deck.description, last_modified: @deck.last_modified, title: @deck.title }
    assert_redirected_to deck_path(assigns(:deck))
  end
